...
class Mahasiswa extends User {
    ...
    public void login() {
        ...
        if (getNama().equalsIgnoreCase("Muhammad Syakhish Al Hanif") && getNim().equals("202410370110189")) { // Menggunakan equalsIgnoreCase() agar perbandingan nama tidak case-sensitive
